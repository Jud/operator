...
def dump_reference(model_id, output_dir, prompt_cache_dir=None):
    ...
    for i, layer in enumerate(model.model.layers):
        ...
        if layer_type == "linear_attention":
            ...
            # No monkey-patching — it changes prefill behavior and corrupts decode references.
            # DeltaNet internals verified as black box: qkv_out + z_out + cache → out_proj_input
            delta_idx += 1
        else:
            # Standard attention
